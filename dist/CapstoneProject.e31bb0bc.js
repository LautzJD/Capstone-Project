...
_axios.default.get('https://my-json-server.typicode.com/LautzJD/Capstone-Project/cities').then(function (response) {
  ...
  response.data.forEach(function (element) {
    console.log("<option value=\"".concat(element.id, "\">").concat(element.name, "</option>"));
    citySelect.insertAdjacentHTML('beforeend', "<option value=\"".concat(element.id, "\">").concat(element.name, "</option>"));
  });
...
},{"axios":"node_modules/axios/index.js"}],"../../../AppData/Roaming/npm-cache/_npx/11940/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/npm-cache/_npx/11940/node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], null)
