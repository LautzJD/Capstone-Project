...
// lodash is a library of functions//
function linkBuilder(linksArray) {
  var linksHTML = linksArray.map(function (link) {
    var destination = '';

    if (link !== 'Home') {
      destination = (0, _lodash.kebabCase)(link);
    }

    return "\n        <li>\n        <a data-navigo href=\"./".concat(destination, "\">").concat(link, "</a>\n        </li>\n        ");
  }).join(' '); // console.log(linksHTML);//

  return linksHTML;
}

function Navigation(state) {
  return "\n     <div id = \"navigation\">\n\n        <ul>\n            ".concat(linkBuilder(state.nlinks), "\n        </ul>\n\n    </div>\n    ");
} // Duplicate this in footer and change link to navlink for navigation.js and footerlink in the footer.js
},{"lodash":"node_modules/lodash/lodash.js"}],"src/Header.js":[function(require,module,exports) {
"use strict";
...
function About() {
  return "\n    <h1>About:</h1>\n    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem culpa aliquid amet, similique, nam ab porro iusto esse quod earum quo. Distinctio quibusdam nesciunt rem voluptatum odio quaerat, error ducimus?</h2>\n    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem culpa aliquid amet, similique, nam ab porro iusto esse quod earum quo. Distinctio quibusdam nesciunt rem voluptatum odio quaerat, error ducimus?</h2>\n    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem culpa aliquid amet, similique, nam ab porro iusto esse quod earum quo. Distinctio quibusdam nesciunt rem voluptatum odio quaerat, error ducimus?</h2>\n    ";
}
},{}],"src/pages/Contact.js":[function(require,module,exports) {
"use strict";
...
},{"./Home":"src/pages/Home.js","./Suggest":"src/pages/Suggest.js","./About":"src/pages/About.js","./Contact":"src/pages/Contact.js"}],"src/Content.js":[function(require,module,exports) {
"use strict";
...
function Footer(state) {
  return "\n     <div id = \"footer\">\n\n        <ul>\n            ".concat(linkBuilder(state.flinks), "\n        </ul>\n\n    </div>\n    ");
}
},{"lodash":"node_modules/lodash/lodash.js"}],"state/Home.js":[function(require,module,exports) {
"use strict";
...
},{}],"state/Suggest.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"state/About.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"state/Contact.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"state/Cities.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Home":"state/Home.js","./Suggest":"state/Suggest.js","./About":"state/About.js","./Contact":"state/Contact.js","./Cities":"state/Cities.js","./Active":"state/Active.js"}],"state/store.js":[function(require,module,exports) {
"use strict";
...
var _default = Store;
exports.default = _default;
},{"../state":"state/index.js"}],"node_modules/navigo/lib/navigo.min.js":[function(require,module,exports) {
var define;
...
function render(state) {
  var page = state[state.active];
  root.innerHTML = "\n    ".concat((0, _Navigation.default)(page), "\n    ").concat((0, _Header.default)(page), "\n    ").concat((0, _Content.default)(state), "\n    ").concat((0, _Footer.default)(page), "\n    ");
}
...
_axios.default.get('https://my-json-server.typicode.com/LautzJD/Capstone-Project/cities').then(function (response) {
  store.dispatch(function (state) {
    return Object.assign(state, {
...
},{"./src/Navigation":"src/Navigation.js","./src/Header":"src/Header.js","./src/Content":"src/Content.js","./src/Footer":"src/Footer.js","lodash":"node_modules/lodash/lodash.js","./state/store":"state/store.js","navigo":"node_modules/navigo/lib/navigo.min.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
